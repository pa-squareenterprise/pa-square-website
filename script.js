...
function loadZohoForm(key) {
  ...
  script.onerror  = () => {
    if(loader) loader.innerHTML = '<p style="color:#c0392b;font-size:13px;text-align:center;padding:20px">⚠ Could not load form. <a href="https://wa.me/919751962727" style="color:var(--gold)">Contact us on WhatsApp</a></p>';
  };
